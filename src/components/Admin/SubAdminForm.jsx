...
//           ? assignedSubAdmins
//           : [],
//       permission_edit_condition: permissionEditCondition ? 1 : 0,
//       permission_upload_files: permissionUploadFiles ? 1 : 0,
//     };
...
//     setRanges(subAdmin.ranges);
//     setAssignedSubAdmins(subAdmin.assigned_subadmins);
//     setPermissionEditCondition(subAdmin.permission_edit_condition === 1);
//     setPermissionUploadFiles(subAdmin.permission_upload_files === 1);
//   };
//   const handleDeleteSubAdmin = async (id) => {
//     const result = await Swal.fire({
//       title: "Are you sure?",
...
//       dataIndex: "permission_edit_condition",
//       key: "permission_edit_condition",
//       render: (val) => (val === 1 ? "Yes" : "No"),
//     },
//     {
//       title: "Upload Permission",
//       dataIndex: "permission_upload_files",
//       key: "permission_upload_files",
//       render: (val) => (val === 1 ? "Yes" : "No"),
//     },
//     {
//       title: "Actions",
